...
class TestDatasetName(Enum):
    ...
    @property
    def name(self) -> str:
        """Return the member name without a leading underscore, if any."""
        return self._name_.lstrip('_')
...
dataset_paths = {
    ...
    TestDatasetName._1940CENSUS_AZ_TestKitStrata_RED.name: f'{CENSUS1940_DATASET}/AZ_red_strata',
}
