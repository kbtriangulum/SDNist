...
def privacy_score(
    ...
    if 'Unique Exact Matches' in metrics:
    ...
    if "Apparent Match Distribution" in metrics:
        ...
        if "apparent_match_distribution" in dataset.config:
            if "quasi_identifier_features" in dataset.config["apparent_match_distribution"]:
                quasi_idf = dataset.config["apparent_match_distribution"]["quasi_identifier_features"]
